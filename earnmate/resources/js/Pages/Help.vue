            ...
            <div class="bg-white mb-10 px-10 pt-10 md:pt-20 border rounded-xl w-full">
                ...
                <div id="methods" class="mt-10 text-lg">
                    ...
                    <div class="mt-5 md:pl-20">
                        <p class="mb-4 font-bold text-2xl text-gray-900">2 Go to spot section and search for USDT </p>
                        <div class="ml-10 mockup-phone">
                            <div class="camera"></div>
                            <div class="w-80 display">
                    ...
                    <div class="mt-5 md:pl-20">
                        <p class="mb-4 font-bold text-2xl text-gray-900">3 Click withdraw </p>
                        <div class="ml-10 mockup-phone">
                            <div class="camera"></div>
                            <div class="w-80 display">
                    ...
                    <div class="mt-5 md:pl-20">
                        <p class="mb-4 font-bold text-2xl text-gray-900">4 Select send via Email/Phone/ID </p>
                        <div class="ml-10 mockup-phone">
                            <div class="camera"></div>
                            <div class="w-80 display">
                    ...
                    <div class="mt-5 md:pl-20">
                        <p class="mb-4 font-bold text-2xl text-gray-900">2 Search for usdt </p>
                        <div class="ml-10 mockup-phone">
                            <div class="camera"></div>
                            <div class="w-80 display">
