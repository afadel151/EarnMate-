    ...
    <AdminLayout>
        <div class="p-10 w-full  flex flex-col justify-center items-center">
            ...
            <DataTable v-model:filters="filters" class="w-[100%]" :value="props.offers" paginator :rows="10"
                ...
                <Column field="method" header="Name" sortable >
                    <template #body="{ data }">
                        {{ data.method }}
                    </template>
                ...
                <Column field="real_max_users" header="Platform" sortable >
                    <template #body="{ data }">
                        {{ data.real_max_users }}
                    </template>
                    <template #filter="{ filterModel }">
                ...
                <Column field="fake_max_users" header="Type" sortable >
                    <template #body="{ data }">
                        {{ data.fake_max_users }}
                    </template>
                    <template #filter="{ filterModel }">
                ...
                <Column field="required_amount" header="Link" sortable >
                    <template #body="{ data }">
                ...
                <Column field="days" header="Start day" sortable >
                    <template #body="{ data }">
                        {{ data.days }}
                    </template>
                    <template #filter="{ filterModel }">
                ...
                <Column field="start_date" header="Start time" sortable >
                    <template #body="{ data }">
                        {{ data.start_date }}
                    </template>
                    <template #filter="{ filterModel }">
                ...
                <Column field="start_time" header="Admin" sortable >
                    <template #body="{ data }">
                        {{ data.start_time }}
                    </template>
                    <template #filter="{ filterModel }">
