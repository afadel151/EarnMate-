...
<template>
    <MyLayout>
        <div
            ...
            <div
                class="backdrop-blur-md bg-white/70 shadow-sm md:col-span-2 rounded-xl md:row-span-2 p-4 md:p-6 md:col-start-3">
                <div class="w-full h-full rounded-xl grid p-2 gap-4 md:gap-4 grid-cols-2 grid-rows-2">
                    <div
                        class="col-span-2 shadow-sm rounded-lg flex flex-col space-y-2 justify-around items-stretch px-6">
